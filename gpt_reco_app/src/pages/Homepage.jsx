...
function Homepage() {
  return (
      <div className="py-section px-4 sm:px-6 lg:px-8 max-w-5xl mx-auto">
        <h1 className="text-3xl sm:text-6xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-brand-secondary via-brand-accent to-brand-primary drop-shadow-lg mb-12 text-center">
