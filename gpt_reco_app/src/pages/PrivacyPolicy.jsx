...
function PrivacyPolicy() {
  return (
    <div className="font-primary max-w-4xl mx-auto py-8 px-4">
      <h1 className="text-3xl font-bold font-secondary mb-4">Privacy Policy</h1>

      <h2 className="text-2xl font-semibold font-secondary mb-3">🛡️ Our Commitment as an EU Company</h2>
      <p className="mb-6">
      ...
      <h2 className="text-2xl font-semibold font-secondary mb-3">📜 Understanding GDPR</h2>
      <p className="mb-6">
      ...
      <h2 className="text-2xl font-semibold font-secondary mb-3">🔒 Our Data Collection Practices</h2>
      <p className="mb-6">
      ...
      <h2 className="text-2xl font-semibold font-secondary mb-3">📈 Logs and Data We Do Collect</h2>
      <p className="mb-6">
      ...
      <h2 className="text-2xl font-semibold font-secondary mb-3">🤝 Your Privacy Matters to Us</h2>
      <p>
