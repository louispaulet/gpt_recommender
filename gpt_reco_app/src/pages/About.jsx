...
const About = () => {
  return (
    <div className="font-primary py-12 px-4 sm:px-6 lg:px-8 max-w-5xl mx-auto">
      <section className="mb-10 p-6 bg-primary-100 rounded-lg shadow-md text-primary-900 font-medium text-center text-lg">
        <h1 className="text-4xl font-extrabold font-secondary mb-6">About GPT YouTube Channel Recommender</h1>
        <h2 className="text-2xl font-extrabold font-secondary mb-3 tracking-wide uppercase border-b-2 border-primary-400 pb-1">
          What is this?
        </h2>
