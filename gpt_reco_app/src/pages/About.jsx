...
const About = () => {
  return (
      <div className="py-section px-4 sm:px-6 lg:px-8 max-w-5xl mx-auto">
        <section className="mb-10 p-6 bg-brand-light rounded-lg shadow-md text-brand-dark font-medium text-center text-lg">
          <h1 className="text-4xl font-extrabold mb-6 text-brand-primary">About GPT YouTube Channel Recommender</h1>
          <h2 className="text-2xl font-extrabold mb-3 tracking-wide uppercase border-b-2 border-brand-primary pb-1">
          What is this?
        </h2>
