  ...
  return (
    <main className="max-w-3xl mx-auto p-8 bg-white rounded-lg shadow-lg mt-10">
      ...
      <input
        ...
        className="w-full p-3 border border-gray-300 rounded-lg mb-6 focus:outline-none focus:ring-2 focus:ring-brand-primary focus:border-brand-primary transition"
      />
      <button
        onClick={checkApiKey}
