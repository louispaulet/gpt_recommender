...
function HomepageComponent() {
  ...
  return (
    <main className="font-primary max-w-3xl mx-auto p-8 bg-white rounded-lg shadow-lg mt-10">
      <h2 className="text-3xl font-extrabold font-secondary mb-6 text-gray-900">Set up your OpenAI API key</h2>
      <input
        type="text"
